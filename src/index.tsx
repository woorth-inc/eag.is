...
const App = () => {
  ...
  const setAnimationOfPage = useCallback((page: string, animation: string) => {
    switch (page) {
      case 'home': {
  ...
  const handlePageTransition = useCallback((nextPage: string) => {
  ...
  const handleWindowResize = useCallback(() => {
    ...
    if (isTablet && goHomeFlag && currentPage !== 'home') {
