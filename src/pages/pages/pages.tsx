...
interface Attrs extends Props, Link {
...
const LinksWrapper = styled.div.attrs((props: Partial<Attrs>) => ({
  media: props.media || defaultMedia,
  links: props.links,
}))`
  display: grid;
...
const Link = styled.div.attrs((props: Partial<Attrs>) => ({
  size: props.size,
  icon: props.icon,
}))`
    font-size: 25px;
