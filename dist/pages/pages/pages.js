import s from"../../../_snowpack/pkg/react.js";import n from"../../../_snowpack/pkg/styled-components.js";import"./style.css.proxy.js";const l=n.div`
    text-align: left;
    position: absolute;
    left: 50%;
    ...
    /* TODO: モバイル時に表示させる */
    opacity: ${({animation:e,isMobile:t})=>t||e==="fadein"?0:e==="fadeout"?1:0};
    ${({animation:e,firstRender:t,isMobile:o})=>o||t?"":`animation: ${e}-pages 800ms ease 50ms forwards;`}
`,p=n.div`
    display: grid;
